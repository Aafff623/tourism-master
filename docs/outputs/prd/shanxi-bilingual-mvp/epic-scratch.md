# Epic scratch — shanxi-bilingual-mvp

## Wave 1（已归档）

| task | handoff | status |
|---|---|---|
| weapp-mock-integration | `handoff/archive/shanxi-scenic-mock-data/weapp-mock-integration.md` | archived |
| weapp-locale-shell | `handoff/archive/shanxi-bilingual-mvp/weapp-locale-shell.md` | archived |
| weapp-spot-list-detail | `handoff/archive/shanxi-bilingual-mvp/weapp-spot-list-detail.md` | archived |
| weapp-home-hotspots | `handoff/archive/shanxi-bilingual-mvp/weapp-home-hotspots.md` | archived |
